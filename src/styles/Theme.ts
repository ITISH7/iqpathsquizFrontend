...
export const themes: Record<string, Theme> = {
  light: {
    colors: {
      ...
      themeText: '#000000',
      themeColor: '#001380',
      themeGradient: 'radial-gradient(circle at 10% 20%, rgb(75, 108, 183) 0%, rgb(55, 82, 141) 90%)',
      background: '#E5E5E5',
      ...
      buttonBackground: 'radial-gradient(circle at 10% 20%, rgb(75, 108, 183) 0%, rgb(55, 82, 141) 90%)',
      selectedAnswer: '#d6e2ff',

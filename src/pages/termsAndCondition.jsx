...
const TermsAndConditions = () => {
  ...
  return (
    <div style={styles.container}>
      <h1 style={styles.titleHeading}>Terms and Conditions</h1>

      <p style={styles.paragraph}>Welcome to iQPaths!</p>
      <p style={styles.paragraph}>
        These terms and conditions outline the rules and regulations for the use
        of iQPaths's Website, located at{" "}
        <a
      ...
      <p style={styles.paragraph}>
        ...
        conditions. Do not continue to use iQPaths if you do not agree to all of
      ...
      <h2 style={styles.heading}>Terminology</h2>
      <p style={styles.paragraph}>
        The following terminology applies to these Terms and Conditions, Privacy
      ...
      <ul style={styles.list}>
        <li style={styles.listItem}>
          "Client", "You", and "Your" refer to you, the person logging onto this
          website and complying with the Company's terms and conditions.
        </li>
        <li style={styles.listItem}>
          "The Company", "Ourselves", "We", "Our", and "Us" refer to our
          Company.
        </li>
        <li style={styles.listItem}>
      ...
      <p style={styles.paragraph}>
        We employ the use of cookies. By accessing iQPaths, you agreed to use
        cookies in agreement with iQPaths's Privacy Policy.
      </p>
      ...
      <p style={styles.paragraph}>
        Unless otherwise stated, iQPaths and/or its licensors own the
        intellectual property rights for all material on iQPaths. All
        intellectual property rights are reserved. You may access this from
        iQPaths for your own personal use, subject to restrictions set in these
        terms and conditions.
      </p>
      <p style={styles.paragraph}>You must not:</p>
      <ul style={styles.list}>
        <li style={styles.listItem}>Republish material from iQPaths</li>
        <li style={styles.listItem}>
          Sell, rent, or sub-license material from iQPaths
        </li>
        <li style={styles.listItem}>
          Reproduce, duplicate, or copy material from iQPaths
        </li>
        <li style={styles.listItem}>Redistribute content from iQPaths</li>
      </ul>

      <p style={styles.paragraph}>
        Parts of this website offer an opportunity for users to post and
        exchange opinions and information in certain areas of the website.
        iQPaths does not filter, edit, publish or review Comments prior to their
        presence on the website. Comments do not reflect the views and opinions
        of iQPaths,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, iQPaths shall not be liable for the
      ...
      <p style={styles.paragraph}>
        iQPaths reserves the right to monitor all Comments and to remove any
      ...
      <p style={styles.paragraph}>
        You hereby grant iQPaths a non-exclusive license to use, reproduce, edit
      ...
      <ul style={styles.list}>
        ...
        <li style={styles.listItem}>dot.com community sites;</li>
        <li style={styles.listItem}>
          associations or other groups representing charities;
        </li>
        <li style={styles.listItem}>online directory distributors;</li>
        <li style={styles.listItem}>internet portals;</li>
        <li style={styles.listItem}>accounting, law and consulting firms;</li>
        <li style={styles.listItem}>
      ...
      <p style={styles.paragraph}>
        ...
        the hyperlink compensates the absence of iQPaths; and (d) the link is in
      ...
      <p style={styles.paragraph}>
        ...
        e-mail to iQPaths. Please include your name, your organization name,
      ...
      <ul style={styles.list}>
        <li style={styles.listItem}>By use of our corporate name; or</li>
        <li style={styles.listItem}>
      ...
      <p style={styles.paragraph}>
        No use of iQPaths's logo or other artwork will be allowed for linking
        absent a trademark license agreement.
      </p>

      <h2 style={styles.heading}>iFrames</h2>
      <p style={styles.paragraph}>
      ...
      <h2 style={styles.heading}>Removal of links from our website</h2>
      <p style={styles.paragraph}>

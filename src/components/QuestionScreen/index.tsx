    ...
    <PageCenter>
      ...
      <QuizContainer selectedAnswer={selectedAnswer.length > 0}>
        ...
        <ButtonWrapper>
          <Button
            ...
            onClick={onClickNext}
            icon={<img src="src\assets\icons\next.svg" alt="Check Icon" style={{ width: '24px', height: '24px' }} />}
            iconPosition="right"
      ...
      {(showTimerModal || showResultModal) && (
        <ModalWrapper
          ...
          onClick={handleModal}
          icon={showResultModal ? 
            <img src="src\assets\icons\check.svg" alt="Check Icon" style={{ width: '24px', height: '24px' }} />
           : 
           <img src="src\assets\icons\timer.svg" alt="Check Icon" style={{ width: '24px', height: '24px' }} />
          }
